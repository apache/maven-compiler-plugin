...
/**
 * Configuration aspects for incremental builds.
 *
 * <p>The actual change detection, state persistence, and stale output cleanup are handled by the
 * {@link org.apache.maven.api.build.context.BuildContext BuildContext} API. This class provides
 * the {@link Aspect} enumeration that configures which kinds of changes should be tracked
 * and how they affect the rebuild decision (partial vs. full).</p>
 */
final class IncrementalBuild {
    ...
    /**
     * Private constructor — this class contains only static members.
     */
     ...
     *
     * @param sourceFiles return value of modified sources filtering.
     */
